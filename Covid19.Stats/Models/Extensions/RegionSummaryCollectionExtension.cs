...
namespace Covid19.Stats.Models.Extensions
{
    ...
    //{
    //    public static Dictionary<string, int> GetCasesMapInfo(this IEnumerable<TableRowSummary> countrySummaries)
    //    {
    ...
    //        return pairs;
    //    }
    //    public static Dictionary<string, int> GetDeathsMapInfo(this IEnumerable<TableRowSummary> countrySummaries)
    //    {
    //        Dictionary<string, int> pairs = new();
    //        foreach (var cs in countrySummaries)
    //        {
